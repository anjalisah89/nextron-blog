...
const Header = () => {
  return (
    <div >
      <header className="sticky top-0 z-50 w-full pl-12 pr-12 border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 max-w-screen-2xl items-center">
          <div className="mr-4 hidden md:flex">
            <a className="mr-8 flex items-center space-x-2" href="/">
                <Image src="/image/logo.svg" className="h-8 w-8" width={800} height={800}/>
